            ...
            <div className="p-4">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-3">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span>{format(startAt, 'MM/dd/yy')}</span>
                        <span className='text-black'>{format(startAt, 'hh:mm')} - </span>
                        <span >{format(endAt, 'MM/dd/yy,')}</span>
                        <span className='text-black'>{format(endAt, 'hh:mm')}</span>
                    </div>
                </div>
